					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="produk.php?id=<?= $row['id_produk']; ?>"><img src="img/<?= $row['gambar']; ?>"  href="produk.php?id=<?= $row['id_produk']; ?>" width="100" alt=""></a>
								<a class="second__img animation1" href="produk.php?id=<?= $row['id_produk']; ?>"><img src="img/<?= $row['gambar']; ?>"  href="produk.php?id=<?= $row['id_produk']; ?>" alt="product image"></a>
								<div class="hot__box">
