...
class user{
	...
	function addcart($con,$iduser,$idproduk,$idbahan,$tanggal){
		$sub=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM produk where id_produk='$idproduk' "));$harga=$sub['harga'];$subtotal=1*$harga;
		$sql=mysqli_query($con,"INSERT INTO keranjang set id_user='$iduser',id_produk='$idproduk',id_bahan='$idbahan',tanggal='$tanggal',jumlah='1',subtotal='$subtotal'");
