...
if(empty($_GET['thisposition'])){
	...
	else if($to=='addcart'){ $idproduk=base64_decode($_POST['id_produk']); $iduser=base64_decode($_POST['id_user']); $idbahan=base64_decode($_POST['id_bahan']);
		$ru->addcart($con,$iduser,$idproduk,$idbahan,date('Y-m-d'));
	}
