					...
					<?php
						...
						$query = $conn->query($sql);
							while($row = $query->fetch_assoc()){
								...
								<tr>
									<td>
										<a href="delete_item.php?id=<?php echo $row['id_produk']; ?>&index=<?php echo $index; ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a>
									</td>
