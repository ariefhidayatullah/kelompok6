...
$carikode = mysqli_query($conn, "SELECT id_krw FROM karyawan ") or die(mysqli_error($id_admin));
// menjadikannya array
      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="../register.php">tambah akun admin</a>
      ...
      <div id="content">
        ...
        <div class="container">
          ...
          <div class="text-center">
            <h1 class="h4 text-gray-900 mb-4">tambahkan data karyawan!</h1>
          </div>
          <form class="user" method="post" action="">
            <div class="form-group row">
              <div class="col mb-3 mb-sm-0">
                <input type="hidden" class="form-control form-control-static" id="id_krw" name="id_krw" value="<?= $kode_otomatis; ?>" readonly>
              </div>
            </div>
            <div class="form-group row">
              <div class="col mb-3 mb-sm-0">
                <input type="text" class="form-control form-control-static" id="nama_krw" name="nama_krw" placeholder="masukkan nama karyawan....">
              </div>
            </div>
            <div class="form-group row">
              <div class="col mb-3 mb-sm-0">
            ...
            <div class="form-group row">
              <div class="col mb-3 mb-sm-0">
                <input type="text" class="form-control form-control-static" id="nohp_krw" name="nohp_krw" placeholder="masukkan no hp...">
              </div>
            </div>
            <div class="text-center">
