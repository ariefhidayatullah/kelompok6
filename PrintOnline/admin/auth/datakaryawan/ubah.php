...
$mhs = query("SELECT * FROM karyawan WHERE id_krw = '$id_karyawan'");
                    ...
                    <form class="user" action="" method="POST">
                        <div class="form-group row">
                            <div class="col mb-3 mb-sm-0">
                                <input class="form-control form-control-static" type="hidden" name="id_krw" id="id_krw" required value="<?= $row['id_krw']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col mb-3 mb-sm-0">
                                <label for="jenis_produk">nama karyawan : </label>
                                <input class="form-control form-control-static" type="text" name="nama_krw" id="nama_krw" required value="<?= $row['nama_krw']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col mb-3 mb-sm-0">
                                <label for="jenis_produk">email : </label>
                                <input class="form-control form-control-static" type="email" name="email" id="email" required value="<?= $row['email']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col mb-3 mb-sm-0">
                                <label for="jenis_produk">no hp : </label>
                                <input class="form-control form-control-static" type="text" name="nohp_krw" id="nohp_krw" required value="<?= $row['nohp_krw']; ?>">
                            </div>
                        </div>
                        <div class="text-center">
                            <input class="btn btn-primary" name="submit" type="submit" value="ubah!">
                            </input>
                            <a href="datakaryawan.php" class="btn btn-warning" name="submit" type="submit">
                                kembali
                            </a>
                        </div>
                    </form>
